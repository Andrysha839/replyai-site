...
const translations: Record<string, any> = {
  ...
  uk: {
    ...
    connectTitle: "ЗВ'ЯЗОК І СОЦМЕРЕЖІ",
    ...
    <main className="min-h-screen bg-[#111211] text-[#f1eee7] selection:bg-[#d7c6a5] selection:text-black">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="mt-16 border-t border-white/10 pt-8">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/kadex.vip"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 border border-white/15 bg-white/[0.02] px-4 py-3 transition hover:border-[#d7c6a5] hover:bg-white/[0.05]"
                >
                  ...
                  <div className="flex flex-col">
                    <span className="text-[11px] font-medium tracking-[0.1em] text-white">Instagram</span>
                    <span className="text-[9px] text-white/40">@kadex.vip</span>
                  </div>
                </a>

                {/* Facebook */}
                <a
                  href="https://www.facebook.com/profile.php?id=61580975601937"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 border border-white/15 bg-white/[0.02] px-4 py-3 transition hover:border-[#d7c6a5] hover:bg-white/[0.05]"
                >
                  ...
                  <div className="flex flex-col">
                    <span className="text-[11px] font-medium tracking-[0.1em] text-white">Facebook</span>
                    <span className="text-[9px] text-white/40">Kadex VIP</span>
                  </div>
                </a>
      ...
      <footer className="bg-[#111211]">
        <div className="mx-auto flex max-w-[1400px] flex-col justify-between gap-10 px-6 py-12 md:flex-row md:items-start lg:px-10">
          ...
          {/* Ліва колонка: Логотип і ряд клікабельних іконок соцмереж */}
          <div className="flex flex-col gap-6">
            <div>
            ...
            <div className="flex items-center gap-3">
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/andrii-kolotylo" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex h-9 w-9 items-center justify-center border border-white/15 bg-white/[0.02] transition hover:border-[#d7c6a5] hover:bg-white/[0.05]">
                <svg className="w-3.5 h-3.5 fill-[#d7c6a5]" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              </a>
              {/* Twitter / X */}
              <a href="https://twitter.com/KadexVIP" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="flex h-9 w-9 items-center justify-center border border-white/15 bg-white/[0.02] transition hover:border-[#d7c6a5] hover:bg-white/[0.05]">
                <svg className="w-3.5 h-3.5 fill-[#d7c6a5]" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              {/* Instagram */}
              <a href="https://www.instagram.com/kadex.vip" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center border border-white/15 bg-white/[0.02] transition hover:border-[#d7c6a5] hover:bg-white/[0.05]">
                <svg className="w-3.5 h-3.5 fill-[#d7c6a5]" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
              </a>
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61580975601937" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex h-9 w-9 items-center justify-center border border-white/15 bg-white/[0.02] transition hover:border-[#d7c6a5] hover:bg-white/[0.05]">
                <svg className="w-3.5 h-3.5 fill-[#d7c6a5]" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
              </a>
            </div>
          </div>

          {/* Вибір мов у футері з попередженням для російської */}
          <div className="flex flex-col gap-3">
            ...
            {/* Стильне попередження англійською та українською */}
            <p className="text-[9px] tracking-[0.08em] text-white/30 mt-1 max-w-[320px] leading-relaxed">
              ⚠️ Russian language option is restricted. Clicking it leads to irreversible consequences.
              <br />
              Ця кнопка призначена виключно для росіян. Не натискайте її, якщо не хочете непоправних наслідків.
            </p>
          </div>
          ...
          {/* Нижній правий кут: Made in Ukraine друкованими літерами */}
          <div className="flex flex-col justify-end items-end gap-1">
            <div className="text-[9px] tracking-[0.25em] uppercase text-white/30 font-mono">
              MADE IN UKRAINE
            </div>
